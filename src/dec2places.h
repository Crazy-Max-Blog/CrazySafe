...
/*
  64-битный тип данных для работы с числами с двумя знаками после запятой
  ...
  1 844 674 407 370 955.15 ~ 1.8 квадриллиона
  Для сравнения: самый большой тип данных с запятой в C++ ESP32 - long double:
  занимает 8 байт, но 1 бит отводится под знак, 11 под порядок и 52 под мантиссу,
  соответственно самое большое число с двумя знаками после запятой - 45 035 996 273 704.96 ~ 45 триллионов, а это в ~ 40 раз меньше этой реализации
